...
namespace API.Migrations
{
    ...
    [Migration("20250713092144_ver20")]
    partial class ver20
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Models.NhanVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayVaoLam = new DateTime(2025, 7, 13, 16, 21, 42, 794, DateTimeKind.Local).AddTicks(755),
            ...
            modelBuilder.Entity("API.Models.TaiKhoan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d1e3fcb8-1c16-4702-8191-574d1af884b8"),
                            NgayTaoTk = new DateTime(2025, 7, 13, 16, 21, 42, 794, DateTimeKind.Local).AddTicks(693),
                            NguoiDungId = new Guid("99999999-9999-9999-9999-999999999999"),
                            Password = "admin123",
                            UserName = "admin"
                        });
