...
namespace API.Migrations
{
    ...
    [Migration("20250713090804_ver19")]
    partial class ver19
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Models.NhanVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayVaoLam = new DateTime(2025, 7, 13, 16, 8, 2, 749, DateTimeKind.Local).AddTicks(2345),
            ...
            modelBuilder.Entity("API.Models.TaiKhoan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ffbf5dd6-986b-454f-9187-6000e952ad25"),
                            NgayTaoTk = new DateTime(2025, 7, 13, 16, 8, 2, 749, DateTimeKind.Local).AddTicks(2297),
                            NguoiDungId = new Guid("99999999-9999-9999-9999-999999999999"),
                            Password = "admin123",
                            UserName = "admin"
                        });
